...
dijkstra.prototype.refreshData = () => {
  this.q = [];
...
dijkstra.prototype.getIndexWithKey = (searchKey, collection) => {
...
dijkstra.prototype.runAlgorithm = () => {
...
dijkstra.prototype.getSolutionData = () => {};
